...
public class LightningBolt : MonoBehaviour
{
    ...
    [Tooltip("라이트닝 볼트 생성 위치" +
             "If null, StartPosition is used.")]
    public GameObject StartObject;

    [Tooltip("The start position where the lightning will emit from. " +
             "This is in world space if StartObject is null, otherwise this is offset from StartObject position.")]
    ...
    [Range(0.01f, 1.0f)]
    [Tooltip("How long each bolt should last before creating a new bolt. " +
             "In ManualMode, the bolt will simply disappear after this amount of seconds.")]
