...
Shader "Tobyfredson/Simple Coverage (URP)"
{
	Properties
	{
		...
		[ASEEnd]_CoverageFalloff("Coverage Falloff", Range( 1 , 5)) = 5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float Occlusion = pow( tex2DNode156.g , _Float5 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
0;219;1920;667;1617.416;-603.4119;2.158415;True;True
...
Node;AmplifyShaderEditor.PowerNode;178;658.6031,1349.806;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=90F936FFE95289A18626D9EE2805115830A41536